...
/** Tests for {@link AbstractIcebergCommitCallback}. */
public class AbstractIcebergCommitCallbackTest {
    ...
    void testCatalogTableMetadataPathWithStorageType(
        ...
        Path result = AbstractIcebergCommitCallback.catalogTableMetadataPath(mockTable);
    ...
    void testCatalogDatabasePathWithStorageType(
        ...
        Path result = AbstractIcebergCommitCallback.catalogDatabasePath(mockTable);
